    ...
    const sponsorCategories = [
        {
            ...
            priority: 1,
            sponsors: [
                { id: 1, logo: "/sponsors/aws.png" },
                { id: 2, logo: "/sponsors/olioapps.png" },
                { id: 3, logo: "/sponsors/aws.png" },
            ],
        },
        {
            category: "Silver",
            priority: 2,
            sponsors: [{ id: 4, logo: "/sponsors/guru.png" }],
        },
        {
            category: "Community",
            priority: 3,
            sponsors: [
                { id: 5, logo: "/sponsors/training.png" },
                { id: 6, logo: "/sponsors/traitz.png" },
                { id: 7, logo: "/sponsors/cloud.png" },
                { id: 8, logo: "/sponsors/kola.png" },
                { id: 9, logo: "/sponsors/django.png" },
                { id: 10, logo: "/sponsors/light.png" },
            ],
        },
        {
            ...
            priority: 4,
            sponsors: [
                { id: 11, logo: "/sponsors/kola.png" },
                { id: 12, logo: "/sponsors/django.png" },
                { id: 13, logo: "/sponsors/light.png" },
            ],
        },
    ];
